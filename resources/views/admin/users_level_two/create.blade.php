...
<div class="flex items-center flex-wrap justify-between gap20 mb-27">
    ...
    <div class="dropdown default">
        <a href="{{ route('users-level-one-index') }}" class="btn btn-lg btn-secondary" id="add-button">
            {{ __('Back') }}
        </a>
    </div>
</div>
...
<!-- user-create-form -->
<div class="wg-box">
    <form id="form-user" class="form-new-product form-style-1" action="{{ route('users-level-two.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
